...
Ønsker å se på variablene FAST_NUCLEI_T1 (Myonuclei per fiber CSA in Type II) og AGE (alder).

* **Spørsmålet**: Ser man en endring i myonuklei per fiber CSA i type 2 ved økende alder?
  + <u>Alternativ hypotese</u>: Det ses en endring i myonuclei per fiber CSA i type 2 ved økende alder.
  + <u>Null hypoteste</u>: Det er en ingen endring i myonuclei per fiber CSA i type 2 ved økende alder. 
